...
var map;
function initialize() {
      var myLatlng = new google.maps.LatLng(20.315508, 105.618232);
      var myOptions = {
    zoom: 16,
    center: myLatlng,
...
text= "<b style='color:#00F' " + 
         "style='text-align:center'>Vườn quốc gia Cúc Phương!<br />" + 
...
<body onLoad="initialize()">
    <div id="div_id" style="height:500px; width:1000px"></div>
</body>
</html>
