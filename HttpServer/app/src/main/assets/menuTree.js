...
function drawFolder()
{
  ...
  var blank = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
	...
	this.currentTitle = this.nChildren ? "plus.png" : "pw.png";
...
/*		docW = docW + "<div>" + this.currentTitle + "</div>" */
		if (this.level == 1 ) {
			...
			docW = docW + "<td class='tinyMenuCell' valign=middle nowrap width=100%>"
			docW = docW + "<a class='tinymenuLink'"+ "id = '" + this.id +"'	valign=middle href='" + this.hreference + "' TARGET=\"basefrm\""
		}
...
function drawItem()
{
  ...
  var blank = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
	...
	docW = docW + ">" + leftSide + "" + "<img src = \"pw.png\" border=0></img>" + this.desc + blank + "</a>"
  }
  else if(this.level == 3){
		docW = docW + "<td class = 'smallMenuCell' valign=middle nowrap width=100%>"
		docW = docW + "<a class='smallmenuLink'"+ "id = '" + this.id +"' valign=middle href=" + this.link +" onClick = 'javascript:clickOnFolder(" +this.id + ")'"
	docW = docW + ">" + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + "<img src = \"pw.png\" border=0></img>" + this.desc + blank + "</a>"
  }
  else{
		docW = docW + "<td class = 'tinyMenuCell' valign=bottom nowrap width=100%>"
		docW = docW + "<a class='tinymenuLink'"+ "id = '" + this.id +"' valign=middle href=" + this.link +" onClick = 'javascript:clickOnFolder(" +this.id + ")'"
	docW = docW + ">" + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + "<img src = \"pw.png\" border=0></img>" + this.desc + blank + "</a>"
	}
//	docW = docW + "<a class='menuLink' href=" + this.link + ">" + leftSide + this.desc + "&nbsp;&nbsp;" + "</a>"


/*	docW = docW + ">" + leftSide + "&nbsp;&nbsp;" + "<img src = \"pw.png\" border=0></img>" + this.desc + "&nbsp;&nbsp;" + "</a>"*/
	docW = docW + "</td>"
	docW = docW + this.blockEndHTML()
	doc.write(docW)
...
function clickOnFolder(folderId)
{
    ...
    for ( i = nEntries-1; i > 0; i-- )
	{
		...
		/*add by zxm for change bgcolor*/
        	if (folder.id != folderId)
        	{
        		if ( folder.level > 0)
				{
				document.getElementById(folder.id).style.backgroundColor="#2a8dd4";
			}
		}
	...
	{
		/*alert("in clickOnFolder");
		clicked.currentTitle = "minus.png";
		alert("clicked.currentTitle = 'plus.png'");*/
		if ( clicked.currentTitle == "plus.png" )
		{
		...
		if ( clicked.level > 0)
		{
			document.getElementById(clicked.id).style.backgroundColor="#104198";
		}
		/*end add by zxm for change bgcolor*/
	}catch(e)
	{
